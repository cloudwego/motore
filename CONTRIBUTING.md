# Contributing to Motore

:balloon: Thanks for your help improving the project! We are so happy to have you!

There are opportunities to contribute to Motore at any level. It doesn't matter if
...
<img src="https://github.com/cloudwego/motore/raw/main/.github/assets/motore-feishu-dev-group.png" alt="Motore dev group" width="50%" height="50%" />

_This guide is adapted from the [Tokio contributing guide](https://github.com/tokio-rs/tokio/blob/master/CONTRIBUTING.md)_.

## Conduct

See the [Motore Code of Conduct](https://github.com/cloudwego/motore/blob/main/CODE_OF_CONDUCT.md).
...
1. By opening the issue for discussion: For instance, if you believe that you
   have discovered a bug in Motore, creating a new issue in [the cloudwego/motore
...
3. By helping to resolve the issue: Typically this is done either in the form of
   ...
   Motore in a concrete and reviewable manner.

[issue]: https://github.com/cloudwego/motore/issues
...
2. Join the [Motore user group on Feishu](https://applink.feishu.cn/client/chat/chatter/add_by_link?link_token=a17m50a7-79cd-4ece-b14c-c1586e1aa636) and ask for help there.
...
When opening a new issue in the Motore issue tracker, you will be presented
...
cases should be limited, as much as possible, to using only Motore APIs.
...
functional guidelines of the Motore project.

## Pull Requests

Pull Requests are the way concrete changes are made to the code, documentation,
and dependencies in the Motore repository.
...
example), it is either adding new functionality to Motore or it is fixing
existing, broken functionality. In both of these cases, the pull request should
include one or more tests to ensure that Motore does not regress in the future.
...
1. The first line should:
  ...
  * feat: added support for timeout layer
...
**Any Motore community member is welcome to review any pull request**.

All Motore contributors who choose to review and provide feedback on Pull
...
1. Does this change make sense for Motore?
2. Does this change make Motore better, even if only incrementally?
...
avoid stalling the Pull Request. Most nits can typically be fixed by the Motore
...
a particular change that makes Motore better, but the individual might just not
want to have anything to do with Motore ever again. The goal is not just having
good code.
...
The Motore GitHub repository has a lot of issues and PRs to keep track of. This
...
The area label describes the crates relevant to this issue or PR.
 ...
 - **A-motore** This issue concerns the main `motore` crate.
...
Since the Motore project consists of a number of crates, many of which depend on
...
1. Publish the new version to crates.io follow this order: `motore`.
